...
export { AudioData, AudioDecoder, AudioEncoder, EncodedAudioChunk, EncodedVideoChunk, UnsupportedException, VideoDecoder, VideoEncoder, VideoFrame, canvasDrawImage, createImageBitmap, getAudioDecoder, getAudioEncoder, getVideoDecoder, getVideoEncoder, load };
